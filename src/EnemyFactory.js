...
module.exports = {
    enemies: {
        rat: { tileCode: 'RAT', name: 'Giant rat', hp: '2D3', str: '1D4', def: '1D3', spd: 10, luk: 10, canSwim: false, viewDistance: 7, tile: null },
        spider: { tileCode: 'SPIDER', name: 'Spider', hp: '2D3+3', str: '1D10+2', def: '1D5', spd: 12, luk: 10, canSwim: false, viewDistance: 5, tile: null },
        kobold: { tileCode: 'KOBOLD', name: 'Kobold', hp: '1D6+6', str: '2D4', def: '2D4', spd: 10, luk: 15, canSwim: false, viewDistance: 5, tile: null },
